    ...
    <div id="bitPageDialog" title="Pagina eigenschappen" style="display: none">
        <div id="bitTabsPages" class="bitTabs">
            ...
            <div id="tabPageDetails1" class="bitTabPage">
                ...
                <div class="bitPageSettingsCollumnB">
                    <span class="bitInfo" title="Voer hier in of de pagina actief is, in actief, of actief binnen een bepaalde periode.">
                        info</span>
                </div>
                <div class="bitPageSettingsCollumnC">
                ...
                <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Is deze pagina homepage binnen deze folder. Bij navigeren via domeinnaam.nl/foldernaam/ wordt doorgelinkt naar deze pagina.">
                        info</span></div>
                <div class="bitPageSettingsCollumnC">
            ...
            <div id="tabPageDetails3" class="bitTabPage">
                ...
                <!-- NEXT ROW -->
                <div class="bitPageSettingsCollumnA"></div>
                <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Een sitemap.xml is een extra 'plattegrond' voor zoekmachines. Geef hier aan of de pagina in de sitemap dient te worden opgenomen.">
                        info</span></div>
                <div class="bitPageSettingsCollumnC">
                    <span class="checkbox">
                ...
                <!-- NEXT ROW -->
                <div class="bitPageSettingsCollumnA"></div>
                <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Als u het vinkje hier aan zet verschijnt de url van deze pagina in het bestand 'robots.txt' (zie site beheer, algemene instellingen). Hiermee geeft u aan dat deze pagina NIET moet worden geindexeerd door zoekmachines.">
                        info</span></div>
                <div class="bitPageSettingsCollumnC">
                    <span class="checkbox">
