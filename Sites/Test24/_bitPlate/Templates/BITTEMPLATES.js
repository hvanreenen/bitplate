...
var BITTEMPLATES = {
    ...
    initializeCodeMirror: function () {
        ...
        var uiOptions = { path: '/_bitplate/_js/plugins/codemirror-ui/js/', searchMode: 'inline', buttons: ['undo', 'redo', 'jump', 'reindentSelection', 'reindent', 'tag'], tagCallBack: function () { alert('Dit is nog niet geimplementeerd!'); } }
