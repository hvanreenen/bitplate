...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuBarPlaceHolder" runat="server">
    <ul>
        ...
        <li>
            <a href="javascript:void(0);" onclick="BITNEWSLETTERSUBSCRIBER.showImportDefinitionPage();" class="bitBoardTemplates">importDefinitions</a>
            <div>Import templates</div>
        </li>

       <li> 
            <a href="javascript:void(0);" onclick="BITNEWSLETTERSUBSCRIBER.showSubscribers()" class="bitBoardAdmins">subscribers</a>
            <div>Abonnees</div>
        </li>
    ...
    <table id="tableUsers" class="bitGrid" data-control-type="table" cellspacing="0" cellpadding="2" >
        <thead>
            <tr>
                ...
                <td class="bitTableColumn" style="width: 200px" data-sort-field="Name">Subscriber</td>
                <td class="bitTableColumn" style="width: 200px" >Naam</td>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PopupsPlaceHolder" runat="server">
    ...
    <div id="bitNewsGroupPerUserDialog" title="Gebruikergroep kiezen" style="display: none;">
        <ul id="bitNewsUserGroupList" style="list-style-type: none" data-control-type="list">
            <li class="ui-state-default bitScript" style="margin-top: 2px; margin-bottom: 2px;
                padding: 5px"><a data-field="ID" data-title-field="Name" href="javascript:BITNEWSLETTERSUBSCRIBER.addNewsGroupPerUser([list-index]);">
                    <input type="hidden" data-field="ID" />
                    <span data-field="Name"></span><span data-field="Site.Name"></span><span class="remove-script btn-remove-script">
                    </span></a></li>
        </ul>
...
<div id="bitImportSubscribersDialog" title="Abonnees importeren" style="display: none;">
    <div class="bitTabs">
            <ul>
                <li><a href="#tabPageImportSubscribers1">Kies bestand</a></li>
                <li><a href="#tabPageImportSubscribers2">Instellingen</a></li>
                <li><a href="#tabPageImportSubscribers3">Groepen     </a></li>
                <li><a href="#tabPageImportSubscribers4">Importeer   </a></li>
                <li><a href="#tabPageImportSubscribers5">Log         </a></li>
            </ul>
        <!-- TAB1 -->
        <div id="tabPageImportSubscribers1" class="bitTabPage">
            <form method="post" id="UPLOADFORM" action="/_bitAjaxServices/PostHandler.ashx?service=BitSite._bitPlate.Newsletters.NewsletterService&method=UploadSubscriberFile" enctype="multipart/form-data">
                ...
                <div class="bitPageSettingsCollumnA"></div>
                <div class="bitPageSettingsCollumnB"></div>
                <div class="bitPageSettingsCollumnC"><span id="Upload-postback"></span></div>

                <div class="bitPageSettingsCollumnA">Selecteer bestand <br />(.CSV <del>.XML .TXT</del>)</div>
                <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Alleen .CSV .XML .TXT">
                            info</span></div>
                <div class="bitPageSettingsCollumnC">
                <input type="file" name="subscriberFile" accept=".csv,.xml,.txt" data-validation="required" id="subscriberFile"/>
                </div>
                ...
                <div class="bitPageSettingsCollumnA"></div>
                <div class="bitPageSettingsCollumnB"></div>
                <div class="bitPageSettingsCollumnC"><input type="button" value="Upload bestand" onclick="BITNEWSLETTERSUBSCRIBER.uploadFile();" /></div>
        ...
        <div id="tabPageImportSubscribers2" class="bitTabPage">
            <div class="importsettingsSplash">
                ...
                <div id="instellingenCSV">
                    ...
                    <div class="bitPageSettingsCollumnB"></div>
                    <div class="bitPageSettingsCollumnC">
                        <div id="importSelector"><!-- data-field="id" weg laten-->
                            <select id="loadImportDefinitions" data-text-field="Name"  name="importdefinitions" onchange="BITNEWSLETTERSUBSCRIBER.loadImportDefinition()" >
                                <option value="">Er ging iets fout met het laden van deze dropdown</option>
                            </select>
                            </div>
                    </div>
                    <br clear="all" />
                    ...
                    <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="De eerste rij bevat de namen van de velden.">
                            info</span></div>
                    <div class="bitPageSettingsCollumnC"> 
                    ...
                    <div class="bitPageSettingsCollumnA">Scheidingsteken CSV</div>
                    <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Het teken waarmee de gegevens moeten worden gescheiden in de .CSV">
                            info</span></div>
                    <div class="bitPageSettingsCollumnC"> 
                    ...
                    <div class="bitPageSettingsCollumnA">
                        <label>Voornaam kolom:</label><br />
                        <label>Tussenvoegsel Kolom:</label><br />
                        <label>Achternaam kolom:</label><br />            
                        <label>Email kolom:</label><br />
                        <!-- <label>Geslacht kolom </label><br/>-->
                    </div>
                    <div class="bitPageSettingsCollumnB"></div>
                    <div class="bitPageSettingsCollumnC">
                        <select id="selectForeNameColumn" data-field="ForeNameColumnNo"></select><br />
                        <select id="selectNamePrefixColumn" data-field="NamePrefixColumnNo"></select><br />
                        <select id="selectNameColumn" data-field="NameColumnNo"></select><br />
                        <select id="selectEmailColumn" data-validation="required" data-field="EmailColumnNo"></select><br />
                        <!-- <select id="selectGenderColumn" data-field="GenderColumnNo"></select><br/>-->
                    </div>
                    <br clear="all" />

                    <div class="bitPageSettingsCollumnA">Voorbeeld: 
        ...
        <div id="tabPageImportSubscribers3" class="bitTabPage">
            ...
            <div class="settingsTab">
                    ...
                    <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Een nieuwe groep aanmaken en deze automatisch toevoegen al groep">
                            info</span></div>
                    <div class="bitPageSettingsCollumnC"><input type="button" onclick="BITNEWSLETTERSUBSCRIBER.showAddNewGroup()" value="Nieuwe groep" /></div>
                <br clear="all" />


                    <div class="bitPageSettingsCollumnA">
                        Voeg abonnees toe aan een groep</div>
                    <div class="bitPageSettingsCollumnB"> 
                        <span class="bitInfo" title="Kies een groep waar de abonnees in moeten. Verplichte groepen worden automatisch toegevoegd">
                            info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC">                           
                         
                    <select id="importNewsgroupSelector" multiple="true" name="subscribedNewsgroups" runat="server" data-validation="required" data-field="Groups"></select>
                        </div>
                     
                <br clear="all" /> 
                <br clear="all" />

                    <div class="bitPageSettingsCollumnA">Gekozen groepen legen van abonnees</div>
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="De abonees worden uit de gekozen groepen gehaald mits ze niet verplicht zijn.">
                            info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC"> 
                            <input data-field="EmptyGroups" type="checkbox" id="emptygroups" />
                    </div>
                ...
                <br clear="all" />
                    ...
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="Een abonnee met een email adres en achternaam die al bestaan worden overgeslagen. Anders word de abonnee overschreven.">
                            info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC"> 
                            <input data-field="SkipDoubleRecords" type="checkbox" id="skipdoublerecords" />
                        <strong>(uit: overschrijven alle gegevens. Ook groepen)</strong>
                    </div>
                <br clear="all" /> 
                ...
                <div class="bitPageSettingsCollumnC">
                    ...
                    <div class="bitPageSettingsCollumnA">Abonnees verwijderen uit de groepen</div>
                    <div class="bitPageSettingsCollumnB">
                    <span class="bitInfo" title="De abonees in de gekozen groepen worden verwijderd, ook uit de verplichte groepen.">
                            info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC"> 
                            <input data-field="DeleteGroupSubscribers" type="checkbox" id="deletegroupsubscribers" />
                    </div>
                <br clear="all" />
            </div>
        </div>
        ...
        <div id="tabPageImportSubscribers4" class="bitTabPage">
                ...
                <!-- SAVE IMPORT DEFINITIE-->
                    <div class="bitPageSettingsCollumnA">      
                            ...
                            Template opslaan<input type="checkbox" onchange="BITNEWSLETTERSUBSCRIBER.saveImportDefinition();" name="savedefinition"/>
                        </div>
                          
                <div class="bitPageSettingsCollumnB"><span class="bitInfo" title="Sla de gemaakte template op met een naam zodat deze later opnieuw kan worden gebruikt.">
                            info</span></div>
                <div class="bitPageSettingsCollumnC">                         
               ...
               <!-- anders wordt het automatisch gedaan-->
                <div class="bitPageSettingsCollumnA">Abonnees automatisch bevestigen</div>
                <div class="bitPageSettingsCollumnB">
                    <span class="bitInfo" title="De abonnees automatisch bevestigen.">
                            info</span>
                </div>
                <div class="bitPageSettingsCollumnC">
                ...
                <div class="bitPageSettingsCollumnA"></div>
                <div class="bitPageSettingsCollumnB"></div>
                <div class="bitPageSettingsCollumnC">Check of alle gegevens kloppen voordat u op Importeer klikt.</div>
                <br clear="all" />
                
                <div class="bitPageSettingsCollumnA">Importeer</div>
                <div class="bitPageSettingsCollumnB"></div>
                <div class="bitPageSettingsCollumnC"><input type="button" value="Importeer Mail records" onclick="BITNEWSLETTERSUBSCRIBER.ImportSubscribers()" />
