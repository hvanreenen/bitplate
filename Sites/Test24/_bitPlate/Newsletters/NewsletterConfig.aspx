    ...
    <div id="panelDetails" title="Site instellingen">
        ...
        <div class="bitTabs">
            ...
            <div id="tabPageDetails1" class="bitTabPage">
                <div>
                    ...
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="Vul hier de naam van uw site in.">info</span>
                    </div>
                ...
                <div>
                    ...
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="Vul hier uw domeinnaam in.">info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC">
            ...
            <div id="tabPageDetails2" class="bitTabPage">
                <fieldset>
                    <legend>Opt-in instellingen <span class="bitInfo" title="Standaard STMP kan per omgeving worden overschreven">info</span></legend>
            ...
            <div id="tabPageDetails3" class="bitTabPage">
                <fieldset>
                    <legend>Opt-out instellingen <span class="bitInfo" title="Standaard STMP kan per omgeving worden overschreven">info</span></legend>
