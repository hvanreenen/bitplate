        ...
        private string BuildUserGroupsList()
        {
            string format = @"          <li class=""ui-state-default bitScript"" style=""margin-top: 2px; margin-bottom: 2px;padding: 5px"">
                <a href=""javascript:BITAUTHUSERS.addUserGroupPerUser('{0}', '{1}');"">
                    ...
                    <span>{1}</span>@ <span>{2}</span><span class=""remove-script btn-remove-script""></span>
                </a>
            </li>
";
            string returnValue = "";
            ...
            {
                returnValue += String.Format(format, userGroup.ID, userGroup.Name, SessionObject.CurrentSite.Name);
            }
            return returnValue;
