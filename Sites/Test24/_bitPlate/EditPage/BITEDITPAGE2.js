...
var BITEDITPAGE = {
    ...
    initialize: function () {
        ...
        $('#bitEditModuleDialog').initDialog(BITEDITPAGE.saveModuleContentFromPopup, { width: '90%', height: window.innerHeight - 40 });
    ...
    attachDraggable: function () {
        $('.moduleToDrag').draggable({
            ...
            helper: function (event) {
                return $('<div class="ui-widget-header" style="width: 250px; height: 30px;">verplaats me naar de gewenste plaats</div>');
            },
