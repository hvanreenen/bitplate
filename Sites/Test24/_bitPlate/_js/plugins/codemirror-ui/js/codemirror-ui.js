...
CodeMirrorUI.prototype = {
  ...
  initialize: function(textarea, options, mirrorOptions) {
    var defaultOptions = {
      searchMode: 'inline', // Options are 'popup', 'inline' and 'dialog'.  The 'dialog' option needs work.
      imagePath: 'images/silk',
      path: 'js',
      buttons: ['search', 'undo', 'redo', 'jump', 'reindentSelection', 'reindent', 'tag'],
    ...
    this.buttonDefs = {
      ...
      'search': ["Search/Replace", "find_replace_popup", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/find.png", this.find_replace_popup],
      'searchClose': ["Close", "find_replace_popup_close", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/cancel.png", this.find_replace_popup_close],
      'searchDialog': ["Search/Replace", "find_replace_window", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/find.png", this.find_replace_window],
      'undo': ["Undo", "undo", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/arrow_undo.png", this.undo],
      'redo': ["Redo", "redo", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/arrow_redo.png", this.redo],
      'jump': ["Jump to line #", "jump", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/page_go.png", this.jump],
      'reindentSelection': ["Reformat selection", "reindentSelect", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/text_indent.png", this.reindentSelection],
      'reindent': ["Reformat whole document", "reindent", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/page_refresh.png", this.reindent],
      'tag': ["Open tag dialog", "tag", "/_bitplate/_js/plugins/ckeditor/plugins/tags/icons/tags.png", this.tag],
      'about': ["About CodeMirror-UI", "about", '/_bitplate/_js/plugins/codemirror-ui/' + this.options.imagePath + "/help.png", this.about]
    };
