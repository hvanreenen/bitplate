...
<div class="bitPageSettingsCollumnB">
    <span class="bitInfo" title="Kies uit welke datacollectie de gegevens moeten worden geladen.">info</span>          
</div>
...
<div id="dataCollectionPathBrowse">
    <div class="bitPageSettingsCollumnA">Begin in datagroep</div>
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Voor subgroepen/subitems kunt u een filter op groep (parent) instellen. Alleen de groepen/items die onder deze groep vallen worden dan geladen.">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
...
<div id="divModuleListSettings">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Welke gegevens moeten worden getoond? Standaard worden gegevens binnen een groep getoond. De groep is afhankelijk van de gebruikers klik actie. (gebruikersselectie.)">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Stel een filter in. Deze filter zit bovenop eventuele andere filter, zoals filter op groep">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Stel sortering in">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Toon de gegevens vanaf regelnummer (na sortering) in selectie">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Toon maximale aantal regels in selectie">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
...
<div id="defaultDataElementSettings">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Toon ook groepen/items die inactief zijn. Per groep/item kunt u aangegeven of dit item actief of inactief is.">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
...
<div id="divDetailsModuleSettings">
    ...
    <div class="bitPageSettingsCollumnB">
        <span class="bitInfo" title="Deze module toont altijd een vast gegeven en reageert niet op een gebruikersselectie.">info</span> 
    </div>
    <div class="bitPageSettingsCollumnC">
    ...
    <div id="divInitialDataElement">
        ...
        <div class="bitPageSettingsCollumnB">
            <span class="bitInfo" title="Met welk item moet de module worden geladen bij eerste keer, dus nog voordat een eventeuel gebruikersactie heeft plaatsgevonden.">info</span> 
        </div>
        <div class="bitPageSettingsCollumnC">
