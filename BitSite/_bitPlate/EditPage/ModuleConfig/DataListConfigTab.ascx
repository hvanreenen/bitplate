<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataListConfigTab.ascx.cs" Inherits="BitSite._bitPlate.EditPage.ModuleConfig.DataListConfigTab" %>
...
<div class="bitPageSettingsCollumnC">
    <select id="SelectDataCollectionsList" runat="server" data-field="DataCollection.ID"
