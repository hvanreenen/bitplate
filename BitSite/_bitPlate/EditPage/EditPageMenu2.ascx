...
<div id="bitEditPageMenusWrapper">
    ...
    <div id="bitSideBarExpander"><span class="ui-icon ui-icon-triangle-1-e"></span></div>
    <div id="bitSideBar" class="bitSideBarLockedSecure">

        <!-- bitPlateDealer -->
       
        <!--<div class="bitSideBarLock bitSideBarLocked"></div>-->
        <div id="bitSideBarCollapse" class="ui-icon  ui-icon-triangle-1-w"></div>
