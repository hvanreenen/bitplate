<%@ Page Title="" Language="C#" MasterPageFile="~/_bitPlate/bitMasterPages/EditWysiwyg.master"
    AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="BitSite._bitPlate.EditPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">

    <%= BitBundler.ResolveBundleUrl("~/bitEditor") %>
    ...
    <script src="_js/pages/BITEDITPAGE.js" type="text/javascript"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="bitTemplateEditorWrapper"></div>
    ...
    <div id="bitPopups">
        ...
        <div id="bitEditModuleDialog" title="Bewerk module">
            <div id="bitToolbarInPopup"></div>
            <br style="clear: both" />
            <div id="bitStatusbarInPopup"></div>
            <br style="clear: both" />
            <div id="bitModuleTagsInPopup"></div>
            <div id="bitModuleEditorInPopup"></div>
            <br style="clear: both" />
        </div>
