...
<asp:Content ID="Content4" ContentPlaceHolderID="GridPlaceHolder" runat="server">
    ...
    <table data-functionality="newsletterGroupList" id="tableNewsletterGroupList" data-control-type="table" class="bitGrid" cellspacing="0" cellpadding="2" style="display: none">
        <thead>
            <tr>
