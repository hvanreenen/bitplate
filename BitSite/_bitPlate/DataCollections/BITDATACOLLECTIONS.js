...
var BITDATACOLLECTIONS = {
    ...
    openLookupValuePopup: function (index) {
        ...
        //@HJ gaat hier wat fout? IF is nu een workaround
        var languagesJsonString = "{}";
        if (BITDATACOLLECTIONS.dataLookupValue.LanguagesJsonString) {
            languagesJsonString = BITDATACOLLECTIONS.dataLookupValue.LanguagesJsonString;
        }
