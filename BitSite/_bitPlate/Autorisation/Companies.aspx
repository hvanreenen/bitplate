<%@ Page Title="" Language="C#" MasterPageFile="~/_bitPlate/_MasterPages/Grids.master"
    AutoEventWireup="true" CodeBehind="Companies.aspx.cs" Inherits="BitSite._bitPlate.Autorisation.Companies" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
    <script type="text/javascript" src="BITAUTHCOMPANIES.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            BITAUTHCOMPANIES.initialize();
            if (location.hash) {
                ...
                BITAUTHCOMPANIES.loadCompanies();
            }
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuBarPlaceHolder" runat="server">
    <ul>
        ...
        <li><a href="javascript:BITAUTHCOMPANIES.newCompany();" class="bitNavBarButtonAddPage">
            ADDCOMPANY</a>
...
<asp:Content ID="Content4" ContentPlaceHolderID="GridPlaceHolder" runat="server">
    <fieldset>
        ...
        <select id="selectResellerFilter" runat="server" class="selectReseller" onchange="BITAUTHCOMPANIES.filterCompanies(this);">
        </select>
    ...
    <table id="tableCompanies" class="bitGrid" data-control-type="table" cellspacing="0"
        ...
        <thead>
            <tr>
                ...
                <td class="resellerColumn" style="width: 140px" style="display: none" data-sort-field="FK_Company">
                    Handelaar</td>
        ...
        <tbody>
            <tr data-id-field="ID">
                ...
                <td class="bitTableActionButton"><a data-field="ID" data-title-field="Type" href="javascript:BITAUTHCOMPANIES.openCompanyDetailsPopup('[data-field]', '[data-title-field]');"
                    class="bitConfigButton"></a></td>
                <td class="bitTableActionButton"><a data-field="ID" href="javascript:BITAUTHCOMPANIES.removeCompany('[data-field]');"
    ...
    <div id="bitCompanyDetailsDialog" title="Relatie">
        <div class="bitTabs">
            ...
            <div id="tabPageDetails3" class="bitTabPage">
                <i>Email instellingen voor verzenden van een email aan nieuwe bitplate-gebuikers en
                    bij nieuwe wachtwoord aanvragen.
                    <br />
                    Indien niks is ingevuld neemt hij de waarden over van de handelaar.</i>
                <br clear="all" />
