        ...
        <div class="bitTabs">
            ...
            <div id="tabPageDetails1" class="bitTabPage">
                ...
                <div id="divSystemValue" style="display: none">
                    ...
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="Sommige script horen bij het systeem. Deze kunnen niet worden verwijderd noch kan de naam worden gewijzigd.">info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC">
                        Ja
                    </div>
                ...
                <div class="bitPageSettingsCollumnB">
                    <span class="bitInfo" title="Zet 'actief in editor' uit wanneer u wilt dat dit script niet wordt geladen in de pagina tijdens de bewerk modus. Hiermee kunt u voorkomen dat het script conflicteert met scripts die de pagina nodig heeft voor de bewerk-modus. ">info</span>
                </div>
                <div class="bitPageSettingsCollumnC">
                ...
                <div class="bitPageSettingsCollumnB">
                    <span class="bitInfo" title="Script wordt geladen in alle pagina's van de site. In elke pagina van de gehele site staat een refentie naar dit script. U kunt scripts ook koppelen per template of per pagina.">info</span>
                </div>
                <div class="bitPageSettingsCollumnC">
                ...
                <div id="StylesheetProperties" runat="server">
                    ...
                    <div class="bitPageSettingsCollumnB">
                        <span class="bitInfo" title="Media attribuut voor het aanmaken van de <link>-tag. Mogelijke waarden: screen, print, handheld, tv, projector. Gebruik komma (,) voor het opgeven van meerdere media types. Als dit veld leegt blijft geldt de standaard mediasoort, namelijk screen (computer-beeldscherm).">info</span>
                    </div>
                    <div class="bitPageSettingsCollumnC">
