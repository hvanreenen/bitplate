<%@ Page Title="" Language="C#" MasterPageFile="~/_bitPlate/_masterPages/Details.master" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="BitSite._bitPlate.Error" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="DetailsPlaceHolder" runat="server">
    <div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
        ...
        <p>&nbsp;</p>
        <p><strong><asp:Literal runat="server" ID="LiteralErrorMsg"></asp:Literal></strong></p>
        <p>&nbsp;</p>
        <div id="ErrorDetails" style="display: none; word-wrap: break-word;">
            <asp:Literal runat="server" ID="LiteralErrorDetails"></asp:Literal>
        </div>
	</div>
</asp:Content>
