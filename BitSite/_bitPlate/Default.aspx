...
<asp:Content ID="Content1" ContentPlaceHolderID="SlideMenuPlaceHolder" runat="server">
    <div class="theBitMenu">
        <div class="bitLeftSlideMenu" id="bitLeftMenu01"><a href="javascript: void(0);" onclick="BITDASHBOARD.toggleNewsItems();">Nieuws</a></div>
        <div class="bitLeftSlideMenuItems">
            <ul id="newsItemList" data-control-type="list">
                <li><span data-field="listIndex"></span> <a href="javascript:void(0);" data-field="listIndex" data-text-field="Name" onclick="BITDASHBOARD.openNewsItem([data-field])">Item1</a></li>
            </ul>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContentPlaceHolder" runat="server">
    <div style="display: none">
        ...
        <div id="newsItemDetailsPopup" title="Nieuws bericht.">
            <div class="bitPageSettingsCollumnA">Datum</div>
            ...
            <div class="bitPageSettingsCollumnB"></div>
            <div class="bitPageSettingsCollumnC" data-field="Message"></div>
        </div>
    </div>
</asp:Content>