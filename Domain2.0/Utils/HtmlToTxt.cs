...
namespace BitPlate.Domain.Utils
{
    public class HtmlToText
    {
        ...
        private static string ConvertToTxt(string html)
        {
            string txt = "";
        ...
        public static string StripHTML(string source)
        {
            try
            {
                ...
                result = System.Text.RegularExpressions.Regex.Replace(result, @"<( )*li([^>])*>", "\t- ", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
                result = System.Text.RegularExpressions.Regex.Replace(result, @"(<( )*(/)( )*li( )*>)", "\r", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
                ...
                result = System.Text.RegularExpressions.Regex.Replace(result, @"<( )*h([^>])*>", "\r", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
                
                result = System.Text.RegularExpressions.Regex.Replace(result, @"<( )*p([^>])*>", "\r", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
                result = System.Text.RegularExpressions.Regex.Replace(result, @"(<( )*(/)( )*p( )*>)", "\r", System.Text.RegularExpressions.RegexOptions.IgnoreCase);
