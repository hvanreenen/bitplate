...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_create: function() {
		...
		this._renderAxis = function(target) {
			...
			for(var i in this.handles) {
				...
				//2_DO: What's that good for? There's not anything to be executed left
		...
		//2_DO: make renderAxis a prototype function
	...
	_destroy: function() {
		...
		//2_DO: Unwrap at same DOM position
	...
	_renderProxy: function() {
		...
		if(this._helper) {
			...
			this.helper.addClass(this._helper).css({
				...
				zIndex: ++o.zIndex //2_DO: Don't modify option
			});
