<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/Grids.master"
    AutoEventWireup="true" CodeBehind="Resellers.aspx.cs" Inherits="BitMetaServer.Licenses.Resellers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
    <script type="text/javascript" src="BITRESELLERS.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            BITRESELLERS.initialize();
...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuBarPlaceHolder" runat="server">
    <ul>
        ...
        <li><a href="javascript:BITRESELLERS.newReseller();" class="bitNavBarButtonAddPage">ADDDEALER</a>
    ...
    <table id="tableResellers" class="bitGrid" data-control-type="table" cellspacing="0"
        ...
        <thead>
            <tr>
                ...
                <td class="bitTableColumn" style="width: 618px" data-sort-field="Name">Naam</td>
        ...
        <tbody>
            <tr data-id-field="ID" >
                ...
                <td class="bitTableActionButton"><a data-field="ID" data-title-field="Type" href="javascript:BITRESELLERS.openResellerDetailsPopup('[data-field]', '[data-title-field]');"
                    class="bitConfigButton"></a></td>
                <td class="bitTableActionButton"><a data-field="ID" href="javascript:BITRESELLERS.removeReseller('[data-field]');"
    ...
    <div id="bitCompanyDetailsDialog" title="Relatie">
        <div class="bitTabs">
            ...
            <div id="tabPageDetails1" class="bitTabPage">
                ...
                <div class="bitPageSettingsCollumnB"></div>
                <div class="bitPageSettingsCollumnC">
                    <img data-field="Logo" /> <br/>
                    (sla .png op in /_img/ResellerLogos/ met zelfde naam als reseller-naam)
                </div>
                <br clear="all" />
            </div>
            <!--TAB2-->
            ...
            <div id="tabPageDetails3" class="bitTabPage">
                <i><u><b>Instellingen voor verzenden van een email met wachtwoord</b></u> aan nieuwe bitplate-gebuikers en
                    bij het opnieuw aanvragen van een wachtwoord.</i>
                ...
                <br clear="all" />
                <div class="bitPageSettingsCollumnA">Email template<br />
                    Gebruik tags:<br />
                    [name]<br />
                    [email]<br />
                    [password]<br />
