<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigCurrentUser.aspx.cs" Inherits="BitMetaServer.Dialogs.ConfigCurrentUser" %>
...
<body>
    <div class="bitTabs">
        ...
        <div id="tabPageDetails5" class="bitTabPage">
            ...
            <div class="bitPageSettingsCollumnB"></div>
            <div class="bitPageSettingsCollumnC">
                <input type="password" id="bitUserPassword" />
            </div>
            <br clear="all" />
            <div class="bitPageSettingsCollumnA">Voer het wachtwoord nogmaals in:</div>
            <div class="bitPageSettingsCollumnB"></div>
            <div class="bitPageSettingsCollumnC">
                <input type="password" id="bitUserPasswordConfirm" />
            </div>
            <br clear="all" />
